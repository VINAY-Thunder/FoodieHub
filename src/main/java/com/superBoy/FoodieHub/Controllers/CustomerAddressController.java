...
public class CustomerAddressController {
	...
	public ResponseEntity<CustomerAddressResponseDTO> updateCustomerAddress(@PathVariable Long addressID,
		...
		CustomerAddressResponseDTO addressResponseDTO = addressService.updateCustomerAddress(addressID,
				addressRequestDTO);
		return new ResponseEntity<CustomerAddressResponseDTO>(addressResponseDTO, HttpStatus.ACCEPTED);
	}
